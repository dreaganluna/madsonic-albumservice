var winston = require('winston');
  var logger = function(logName, path) {
    ...
    transports: [
      ...
      new (winston.transports.File)({ filename: '/node/logs/log'+ logName +'.log', 'level': 'verbose', 'json': false ,handleExceptions: true,    humanReadableUnhandledException: true, maxsize: 5000000, maxFiles: 5, tailable: true})
    ]
  });
